...
namespace Træpisseren
{
    ...
    public class Gameworld : Game
    {
        ...
        {
            BASE = new Resurser(new Vector2(100, 200), "baseA", SpriteEffects.None, 1, Vector2.Zero, 1F, Color.White, 0);
            MINE = new Resurser(new Vector2(700, 400), "mineC", SpriteEffects.None, 1, Vector2.Zero, 1F, Color.White, 0);
